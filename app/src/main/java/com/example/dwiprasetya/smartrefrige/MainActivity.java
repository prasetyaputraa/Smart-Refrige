...
import com.example.dwiprasetya.smartrefrige.Fragment.LogFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_overview) {
            ...
            getSupportFragmentManager().beginTransaction().replace(R.id.container_main, new LogFragment()).commit();
